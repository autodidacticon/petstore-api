...
from petstore_client.models.customer import Customer  # noqa: E501
...
class TestCustomer(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = petstore_client.models.customer.Customer()  # noqa: E501
        if include_optional :
            return Customer(
                id = 100000, 
                username = 'fehguy', 
                address = [
                    petstore_client.models.address.Address(
                        street = '437 Lytton', 
                        city = 'Palo Alto', 
                        state = 'CA', 
                        zip = '94301', )
