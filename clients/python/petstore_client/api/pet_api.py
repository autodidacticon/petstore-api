...
class PetApi(object):
    ...
    @validate_arguments
    def add_pet(self, pet : Annotated[Pet, Field(..., description="Create a new pet in the store")], **kwargs) -> Pet:  # noqa: E501
    ...
    @validate_arguments
    def add_pet_with_http_info(self, pet : Annotated[Pet, Field(..., description="Create a new pet in the store")], **kwargs):  # noqa: E501
        """Add a new pet to the store  # noqa: E501
    ...
    @validate_arguments
    def find_pets_by_status(self, status : Annotated[Optional[StrictStr], Field(description="Status values that need to be considered for filter")] = None, **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    def find_pets_by_status_with_http_info(self, status : Annotated[Optional[StrictStr], Field(description="Status values that need to be considered for filter")] = None, **kwargs):  # noqa: E501
        """Finds Pets by status  # noqa: E501
    ...
    @validate_arguments
    def find_pets_by_tags(self, tags : Annotated[Optional[conlist(StrictStr)], Field(description="Tags to filter by")] = None, **kwargs) -> List[Pet]:  # noqa: E501
    ...
    @validate_arguments
    def find_pets_by_tags_with_http_info(self, tags : Annotated[Optional[conlist(StrictStr)], Field(description="Tags to filter by")] = None, **kwargs):  # noqa: E501
        """Finds Pets by tags  # noqa: E501
    ...
    def get_pet_by_id_with_http_info(self, pet_id : Annotated[StrictInt, Field(..., description="ID of pet to return")], **kwargs):  # noqa: E501
        ...
        # authentication setting
        _auth_settings = ['petstore_auth', 'api_key']  # noqa: E501
    ...
    @validate_arguments
    def update_pet(self, pet : Annotated[Pet, Field(..., description="Update an existent pet in the store")], **kwargs) -> Pet:  # noqa: E501
    ...
    @validate_arguments
    def update_pet_with_http_info(self, pet : Annotated[Pet, Field(..., description="Update an existent pet in the store")], **kwargs):  # noqa: E501
        """Update an existing pet  # noqa: E501
    ...
    @validate_arguments
    def update_pet_with_form(self, pet_id : Annotated[StrictInt, Field(..., description="ID of pet that needs to be updated")], name : Annotated[Optional[StrictStr], Field(description="Name of pet that needs to be updated")] = None, status : Annotated[Optional[StrictStr], Field(description="Status of pet that needs to be updated")] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def upload_file(self, pet_id : Annotated[StrictInt, Field(..., description="ID of pet to update")], additional_metadata : Annotated[Optional[StrictStr], Field(description="Additional Metadata")] = None, body : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.upload_file(pet_id, additional_metadata, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upload_file_with_http_info(pet_id, additional_metadata, body, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_file_with_http_info(self, pet_id : Annotated[StrictInt, Field(..., description="ID of pet to update")], additional_metadata : Annotated[Optional[StrictStr], Field(description="Additional Metadata")] = None, body : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """uploads an image  # noqa: E501
        ...
        >>> thread = api.upload_file_with_http_info(pet_id, additional_metadata, body, async_req=True)
        >>> result = thread.get()
        ...
        # process the query parameters
        _query_params = []
        if _params.get('additional_metadata') is not None:  # noqa: E501
            _query_params.append(('additionalMetadata', _params['additional_metadata']))
